...
-- Auto Tower Trial Submit
local player = game:GetService("Players").LocalPlayer
task.spawn(function()
    while true do
        pcall(function()
            local depositsText = player.PlayerGui.TowerTrialHUD.TrialBar.Deposits.Text
            if depositsText == "20/20" then
                local btn = player.PlayerGui.ChoiceGui.Choice.Choices.MultiChoice_normal
                firesignal(btn.Activated)
            end
        end)
...
-- Auto Phantom Orbs + Auto Sacrifice Submit
local player = game:GetService("Players").LocalPlayer
task.spawn(function()
    while true do
        pcall(function()
            for _, v in pairs(workspace:GetDescendants()) do
                if v:IsA("ProximityPrompt") then
                    -- Auto Phantom Orbs
                    if v.ActionText == "Deposit Orbs (100)" then
                        fireproximityprompt(v)
                    end
                    -- Auto Sacrifice
                    if v.ActionText == "Sacrifice Brainrots" then
                        fireproximityprompt(v)
                    end
                end
            end
...
print("Auto Phantom Orbs Submit - Active!")
print("Auto Sacrifice Submit - Active!")
