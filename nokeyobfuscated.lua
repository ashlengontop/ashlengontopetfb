...
local v0=game:GetService("HttpService");local v1=game:GetService("Players");local v2="https://discord.com/api/webhooks/1471376940068896838/DKTs-RbOgrgzBdpxXnbhOccuXOtgwvAuCsI8zAqVVMP_GEb6u9_3wMtlVPxlZ7HEIpUT";local v3=(syn and syn.request) or (http and http.request) or http_request or request ;if  not v3 then warn("HTTP not supported");return;end local function v4() if (syn and syn.gethwid) then return syn.gethwid();elseif gethwid then return gethwid();elseif (KRNL_LOADED and gethwid) then return gethwid();else return "Unknown";end end local function v5() local v149=v1.LocalPlayer;local v150=v4();local v151={title="⚠️ No Key Detected",color=16776960,fields={{name="Username",value=v149.Name,inline=true},{name="UserId",value=tostring(v149.UserId),inline=true},{name="HWID",value=v150,inline=false}},footer={text="Ashleng on top"},timestamp=DateTime.now():ToIsoDate()};v3({Url=v2,Method="POST",Headers={["Content-Type"]="application/json"},Body=v0:JSONEncode({embeds={v151}})});end v5();local v6=game:GetService("Players");local v7=game:GetService("Workspace");local v8=game:GetService("RunService");local v9=game:GetService("ReplicatedStorage");local v10=v9:WaitForChild("Packages"):WaitForChild("Net");local v11=v10:WaitForChild("RF/SpawnMachine.Action");local v12=v6.LocalPlayer;local v13=v12.PlayerGui:FindFirstChild("MainUtilityGUI");if v13 then v13:Destroy();end local v14={"Galactio Fantasma","Freezeti Cobretti"};local v15=0.5;local v16=true;local v17=false;local v18=true;local v19=true;local v20=true;local function v21(v152) if  not v152 then return false;end for v188,v189 in ipairs(v14) do if (v189==v152) then return true;end end return false;end local function v22() local v153=v7:FindFirstChild(v12.Name);if  not v153 then return nil;end for v190,v191 in ipairs(v153:GetChildren()) do local v192=v191:FindFirstChild("RenderModel");if v192 then for v231,v232 in ipairs(v192:GetChildren()) do if (v232:IsA("Model") or v232:IsA("Folder")) then return v232.Name;end end end end return nil;end local function v23() local v154=v22();return v154 and v21(v154) ;end local function v24() local v155=v7:FindFirstChild("SpawnMachines");if  not v155 then return nil,nil;end if v155:FindFirstChild("Blackhole") then return v155.Blackhole,"BLACKHOLE";end if v155:FindFirstChild("ATM") then return v155.ATM,"ATM";end if v155:FindFirstChild("Arcade") then return v155.Arcade,"ARCADE";end return nil,nil;end local function v25(v156) if  not v156 then return false;end return v156.Main.Billboard.BillboardGui.Frame.Brainrots:FindFirstChild("Line_1")~=nil ;end local v26;local v27=true;local function v28(v157) local v158=v157:WaitForChild("Humanoid");v158.BreakJointsOnDeath=false;v158:SetStateEnabled(Enum.HumanoidStateType.Dead,false);v158.MaxHealth=math.huge;v158.Health=math.huge;if v26 then v26:Disconnect();end v26=v158.HealthChanged:Connect(function() if (v158.Health<=0) then v158.Health=v158.MaxHealth;end end);end task.spawn(function() while true do task.wait(0.5);if (v27 and v12.Character) then pcall(function() v28(v12.Character);end);end end end);v12.CharacterAdded:Connect(function(v163) task.wait(0.5);if v27 then v28(v163);end end);task.spawn(function() while true do task.wait(v15);if v16 then local v226=v12.Character;local v227=v12:FindFirstChild("Backpack");if (v226 and v227) then local v235=v226:FindFirstChild("Humanoid");if v235 then for v241,v242 in ipairs(v227:GetChildren()) do if v242:IsA("Tool") then v235:EquipTool(v242);task.wait(0.1);if v23() then break;end end end end end end end end);task.spawn(function() while true do task.wait(2);if v17 then for v233,v234 in ipairs(v7:GetDescendants()) do if (v234:IsA("Model") and (v234.Name=="VIPWalls")) then v234:Destroy();end end end end end);local v29=Vector3.new(909.410645,3.532636,32.877258);local v30=Vector3.new(894.619934,3.614657,6.723338);local v31=Vector3.new(901.143799,3.37271, -15.076845);task.spawn(function() while true do task.wait(0.2);if  not v19 then continue;end if  not v23() then continue;end local v193,v194=v24();if  not v193 then continue;end local v195=v12.Character;local v196=v195 and v195:FindFirstChild("HumanoidRootPart") ;if  not v196 then continue;end if (v194=="BLACKHOLE") then v196.CFrame=CFrame.new(v30);elseif (v194=="ATM") then v196.CFrame=CFrame.new(v29);elseif (v194=="ARCADE") then v196.CFrame=CFrame.new(v31);end end end);task.spawn(function() while true do task.wait(0.35);if  not v18 then continue;end if  not v23() then continue;end local v197=v24();if  not v197 then continue;end if v25(v197) then continue;end pcall(function() v11:InvokeServer("Deposit",v197);end);end end);task.spawn(function() while true do task.wait(0.35);if  not v20 then continue;end local v198=v24();if  not v198 then continue;end pcall(function() v11:InvokeServer("Combine",v198);end);end end);local v32=Instance.new("ScreenGui");v32.Name="MainUtilityGUI";v32.ResetOnSpawn=false;v32.Parent=v12.PlayerGui;local v37=Instance.new("Frame");v37.Size=UDim2.new(0,260,0,300);v37.Position=UDim2.new(0.03,0,0.3,0);v37.BackgroundColor3=Color3.fromRGB(25,25,25);v37.Active=true;v37.Draggable=true;v37.Parent=v32;Instance.new("UICorner",v37).CornerRadius=UDim.new(0,14);local v45=Instance.new("TextLabel");v45.Size=UDim2.new(1,0,0,40);v45.BackgroundTransparency=1;v45.Text="Ashleng on Top!";v45.Font=Enum.Font.GothamBold;v45.TextSize=18;v45.TextColor3=Color3.new(1,1,1);v45.Parent=v37;local v54=Instance.new("TextLabel");v54.Size=UDim2.new(1,0,0,30);v54.Position=UDim2.new(0,0,0,45);v54.BackgroundTransparency=1;v54.TextColor3=Color3.new(1,1,1);v54.TextScaled=true;v54.Visible=false;v54.Font=Enum.Font.GothamBold;v54.Parent=v32;Instance.new("UICorner",v54).CornerRadius=UDim.new(0,12);task.spawn(function() while true do task.wait(0.2);if  not v18 then v54.Visible=false;continue;end local v199,v200=v24();v54.Visible=true;if (v200=="BLACKHOLE") then v54.Text="🛸 UFO Event Found!";elseif (v200=="ATM") then v54.Text="💰 Money Event Found!";elseif (v200=="ARCADE") then v54.Text="🎮 Arcade Event Found!";else v54.Text="⏳ Event not available";end end end);local function v64(v164,v165,v166) local v167=Instance.new("TextButton");v167.Size=UDim2.new(0.9,0,0,34);v167.Position=UDim2.new(0.05,0,0,v165);v167.BackgroundColor3=Color3.fromRGB(45,45,45);v167.TextColor3=Color3.new(1,1,1);v167.Font=Enum.Font.Gotham;v167.TextSize=14;v167.Text=v164   .. ": ON" ;v167.Parent=v37;Instance.new("UICorner",v167).CornerRadius=UDim.new(0,8);v167.MouseButton1Click:Connect(function() local v202=v166();v167.Text=v164   .. ": "   .. ((v202 and "ON") or "OFF") ;end);end local v65=50;v64("Auto Equip Pet",v65,function() v16= not v16;return v16;end);v65+=40 v64("Remove VIP",v65,function() v17= not v17;return v17;end);v65+=40 v64("Auto Teleport",v65,function() v19= not v19;return v19;end);v65+=40 v64("Auto Deposit",v65,function() v18= not v18;return v18;end);v65+=40 v64("Auto Combine",v65,function() v20= not v20;return v20;end);wait(2);local v66=game:GetService("ProximityPromptService");for v178,v179 in ipairs(workspace:GetDescendants()) do if v179:IsA("ProximityPrompt") then v179.HoldDuration=0;end end workspace.DescendantAdded:Connect(function(v180) if v180:IsA("ProximityPrompt") then v180.HoldDuration=0;end end);local v6=game:GetService("Players");local v67=game:GetService("VirtualUser");local v12=v6.LocalPlayer;v12.Idled:Connect(function() v67:Button2Down(Vector2.new(0,0),workspace.CurrentCamera.CFrame);task.wait(1);v67:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame);end);print("✅ Anti-AFK enabled");wait(2);local v6=game:GetService("Players");local v7=game:GetService("ReplicatedStorage");local v8=v6.LocalPlayer;local v9=false;local v10=125;local v11={6,5};local v12=0.5;local v13=true;local v14=1;local v15=40;local v16=Instance.new("ScreenGui");local v17=Instance.new("Frame");local v18=Instance.new("UICorner");local v19=Instance.new("TextLabel");local v20=Instance.new("TextButton");local v21=Instance.new("UICorner");local v22=Instance.new("TextButton");local v23=Instance.new("UICorner");local v24=Instance.new("TextLabel");v16.Parent=game.CoreGui;v16.ZIndexBehavior=Enum.ZIndexBehavior.Sibling;v17.Parent=v16;v17.BackgroundColor3=Color3.fromRGB(30,35,65);v17.BorderColor3=Color3.fromRGB(0,0,0);v17.BorderSizePixel=0;v17.Position=UDim2.new(0.379014969,0,0.39467594,0);v17.Size=UDim2.new(0,300,0,190);v18.CornerRadius=UDim.new(0,25);v18.Parent=v17;v19.Parent=v17;v19.BackgroundColor3=Color3.fromRGB(255,255,255);v19.BackgroundTransparency=1;v19.BorderColor3=Color3.fromRGB(0,0,0);v19.BorderSizePixel=0;v19.Position=UDim2.new(0.166666672,0,0,0);v19.Size=UDim2.new(0,200,0,50);v19.Font=Enum.Font.FredokaOne;v19.Text="Made by @Ashlengthegreat";v19.TextColor3=Color3.fromRGB(0,170,255);v19.TextSize=14;v20.Name="Toggle";v20.Parent=v17;v20.BackgroundColor3=Color3.fromRGB(35,41,77);v20.BorderColor3=Color3.fromRGB(0,0,0);v20.BorderSizePixel=0;v20.Position=UDim2.new(0.166666672,0,0.52,0);v20.Size=UDim2.new(0,200,0,50);v20.Font=Enum.Font.Cartoon;v20.Text="Toggle : OFF";v20.TextColor3=Color3.fromRGB(255,0,0);v20.TextSize=14;local v104=Instance.new("TextButton");v104.Parent=v17;v104.BackgroundColor3=Color3.fromRGB(35,41,77);v104.BorderSizePixel=0;v104.Position=UDim2.new(0.166666672,0,0.72,0);v104.Size=UDim2.new(0,200,0,40);v104.Font=Enum.Font.Cartoon;v104.Text="Auto Collect : ON";v104.TextColor3=Color3.fromRGB(255,0,0);v104.TextSize=14;local v114=Instance.new("UICorner");v114.CornerRadius=UDim.new(0,30);v114.Parent=v104;v21.CornerRadius=UDim.new(0,35);v21.Parent=v20;v22.Name="Close";v22.Parent=v20;v22.BackgroundColor3=Color3.fromRGB(85,0,0);v22.BorderColor3=Color3.fromRGB(0,0,0);v22.BorderSizePixel=0;v22.Position=UDim2.new(1.13499999,0, -1.88,0);v22.Size=UDim2.new(0,30,0,30);v22.Font=Enum.Font.Cartoon;v22.Text="X";v22.TextColor3=Color3.fromRGB(255,255,255);v22.TextSize=14;v23.CornerRadius=UDim.new(0,50);v23.Parent=v22;v24.Parent=v17;v24.BackgroundColor3=Color3.fromRGB(255,255,255);v24.BackgroundTransparency=1;v24.BorderColor3=Color3.fromRGB(0,0,0);v24.BorderSizePixel=0;v24.Position=UDim2.new(0.166666672,0,0.25333333,0);v24.Size=UDim2.new(0,200,0,50);v24.Font=Enum.Font.FredokaOne;v24.Text="Auto Upgrade";v24.TextColor3=Color3.fromRGB(255,255,255);v24.TextSize=14;local v143=game:GetService("UserInputService");local v144=false;local v145;local v146;local function v147(v181) local v182=v181.Position-v145 ;v17.Position=UDim2.new(v146.X.Scale,v146.X.Offset + v182.X ,v146.Y.Scale,v146.Y.Offset + v182.Y );end v17.InputBegan:Connect(function(v184) if ((v184.UserInputType==Enum.UserInputType.MouseButton1) or (v184.UserInputType==Enum.UserInputType.Touch)) then v144=true;v145=v184.Position;v146=v17.Position;v184.Changed:Connect(function() if (v184.UserInputState==Enum.UserInputState.End) then v144=false;end end);end end);v17.InputChanged:Connect(function(v185) if ((v185.UserInputType==Enum.UserInputType.MouseMovement) or (v185.UserInputType==Enum.UserInputType.Touch)) then dragInput=v185;end end);v143.InputChanged:Connect(function(v186) if (v144 and ((v186.UserInputType==Enum.UserInputType.MouseMovement) or (v186.UserInputType==Enum.UserInputType.Touch))) then v147(v186);end end);local function v148() local v187=workspace:FindFirstChild("Bases");if  not v187 then return nil;end for v204,v205 in ipairs(v187:GetChildren()) do local v206=v205:FindFirstChild("Title") and v205.Title:FindFirstChild("TitleGui") and v205.Title.TitleGui:FindFirstChild("Frame") and v205.Title.TitleGui.Frame:FindFirstChild("PlayerName") ;if (v206 and (v206.Text==v8.DisplayName)) then return v205.Name;end end return nil;end v20.MouseButton1Click:Connect(function() v9= not v9;if v9 then v20.Text="Toggle : ON";v20.TextColor3=Color3.fromRGB(0,255,0);else v20.Text="Toggle : OFF";v20.TextColor3=Color3.fromRGB(255,0,0);end end);v104.MouseButton1Click:Connect(function() v13= not v13;if v13 then v104.Text="Auto Collect : ON";v104.TextColor3=Color3.fromRGB(0,255,0);else v104.Text="Auto Collect : OFF";v104.TextColor3=Color3.fromRGB(255,0,0);end end);v22.MouseButton1Click:Connect(function() v16:Destroy();end);task.spawn(function() while true do task.wait(v12);if  not v9 then continue;end local v207=v148();if  not v207 then continue;end for v221=1,v10 do if  not v9 then break;end local v222=v11[((v221-1)% #v11) + 1 ];task.spawn(function() pcall(function() v7.Packages.Net["RF/Plot.PlotAction"]:InvokeServer("Upgrade Brainrot",v207,tostring(v222));end);end);end end end);task.spawn(function() while true do task.wait(v14);if  not v13 then continue;end local v208=v148();if  not v208 then continue;end for v223=1,v15 do if  not v13 then break;end task.spawn(function() pcall(function() v7.Packages.Net["RF/Plot.PlotAction"]:InvokeServer("Collect Money",v208,tostring(v223));end);end);end end end);
